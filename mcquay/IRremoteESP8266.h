...
#ifndef DECODE_MCQUAY
#define DECODE_MCQUAY            _IR_ENABLE_DEFAULT_
#endif  // DECODE_MCQUAY
#ifndef SEND_MCQUAY
#define SEND_MCQUAY              _IR_ENABLE_DEFAULT_
#endif  // SEND_MCQUAY
...
#if (DECODE_ARGO || DECODE_DAIKIN || DECODE_FUJITSU_AC || DECODE_GREE || DECODE_MCQUAY || \
...
const uint16_t kMcQuayStateLength = 8;
const uint16_t kMcQuayBits = kMcQuayStateLength * 8;
const uint16_t kMcQuayDefaultRepeat = kNoRepeat;
...
#define MCQUAY_STATE_LENGTH           kMcQuayStateLength
