...
bool rfir::module::device::ac::FZ_YT_Gree::onSvc_get(neb::CJsonObject* pld, cmds::cmd::CmdBase* cmd) {
...
bool rfir::module::device::ac::FZ_YT_Gree::onSvc_set(neb::CJsonObject* pld, cmds::cmd::CmdBase* cmd) {
    ac.ac->setLight(true);
