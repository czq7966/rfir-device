...
void network::module::wifi::AP::initWifiWatch(){
    ...
    GWifiClient.events.onWifiDisconnect.add(this, [this](void*, void*)->void*{
        if (!wifi_timeout_handler) {
            wifi_timeout_handler = GEventTimer.delay(Config.props.ap_start_wifi_timeout, [this](void* arg, void* p)->void*{ 
...
void network::module::wifi::AP::initWebConf(){
    ...
    #ifdef ESP8266
        WiFi.hostname(this->params.apSsid.c_str());
    #elif defined(ESP32)
        WiFi.setHostname(this->params.apSsid.c_str());
    #endif
...
bool network::module::wifi::AP::connectAp(const char* apName, const char* password){
    ...
    return WiFi.softAP(this->params.apSsid.c_str(), this->params.apPass.c_str());
};
