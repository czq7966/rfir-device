#ifndef __CONFIG_CONFIG_FZ_DM3_AC_MEDIA_H__
#define __CONFIG_CONFIG_FZ_DM3_AC_MEDIA_H__
...
#define OTA_UPDATE_URL              "http://betacs.101.com/v0.1/static/preproduction_content_ndcast_ota/ota/fz-dm3-ac-media/cfg.txt"
