#ifndef __CONFIG_CONFIG_TEST_SNIFFER_H__
#define __CONFIG_CONFIG_TEST_SNIFFER_H__

//DEBUG
#define DEBUG_RFIR                  TRUE

//OTA
#define DISABLE_OTA                 TRUE
#define OTA_UPDATE
#define OTA_VERSION_NUMBER          0
#define OTA_VERSION_STRING          "0.0"
...
#define AP_CONFIG_PIN               13  //配合AP_CONFIG_PIN_TIMEOUT，长按后进入AP配网模式
