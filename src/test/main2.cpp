...
//   //irgree.begin();
//   irsend.begin();
//   GDebuger.begin(115200, SERIAL_8N1, SERIAL_FULL);
...
// void loop() {
//   // GDebuger.println("NEC");
//   // irsend.sendNEC(0x00FFE01FUL);
//   // delay(2000);
//   // GDebuger.println("Sony");
//   // irsend.sendSony(0xa90, 12, 2);  // 12 bits & 2 repeats
//   // delay(2000);

//   // GDebuger.println("a Samsung A/C state from IRrecvDumpV2");
...
//   GDebuger.println("a rawData capture from IRrecvDumpV2");
